...
import { posts as apiPosts, fileToDataUrl, type Post } from '@/lib/api';
...
export default function EditarPostPage() {
  ...
  return (
    <div className="mx-auto max-w-2xl space-y-6">
      ...
      <h1 className="text-2xl font-bold text-slate-800">Editar post</h1>
